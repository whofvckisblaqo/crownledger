        ...
        if (receiverAccount) {
          ...
          await Transaction.create({
            ...
            description: JSON.stringify({
              note: note || "",
              recipientName: "Crownledger Internal Transfer",
              from: recipientName,
            }),
          ...
          await Notification.create({
            ...
            message: `$${transaction.amount.toFixed(2)} has been deposited into your checking account from ${recipientName}.`,
            type: "deposit",
                  ...
                  <div style="font-family:'Outfit',sans-serif;max-width:520px;margin:0 auto;padding:0;background:#f9fafb;">
                    ...
                    <div style="background:white;padding:32px;border-radius:0 0 16px 16px;">
                      <p style="color:#6b7280;font-size:15px;margin:0 0 24px;">
                        Hi ${receiverUser.firstName}, you have received <strong>$${transaction.amount.toFixed(2)}</strong> from <strong>${recipientName}</strong> into your Crownledger checking account.
                      </p>
                ...
                <div style="background:#f9fafb;border-radius:12px;padding:20px;margin-bottom:20px;">
                  ...
                  <table style="width:100%;font-size:13px;border-collapse:collapse;">
                    ...
                    <tr style="border-bottom:1px solid #f3f4f6;">
                      ...
                      <td style="padding:8px 0;text-align:right;font-weight:600;color:#374151;">${transferType === "internal" ? "Crownledger Internal" : "External Bank"}</td>
                    </tr>
                    ${note ? `
                    <tr style="border-bottom:1px solid #f3f4f6;">
                      <td style="padding:8px 0;color:#9ca3af;">Note</td>
