            ...
            <div style="font-family:'Outfit',sans-serif;max-width:520px;margin:0 auto;padding:0;background:#f9fafb;">
              ...
              <div style="background:white;padding:32px;border-radius:0 0 16px 16px;">
                ...
                <p style="color:#6b7280;font-size:15px;margin:0 0 24px;">
                  Hi ${transaction.senderId.firstName}, ${isApproved
                ...
                <div style="background:#f9fafb;border-radius:12px;padding:20px;margin-bottom:20px;">
                  ...
                  <table style="width:100%;font-size:13px;border-collapse:collapse;">
                    <tr style="border-bottom:1px solid #f3f4f6;">
                      ...
                      <td style="padding:8px 0;text-align:right;font-weight:600;color:#2563eb;font-family:monospace;">
                        ${transaction.reference}
                      </td>
                    </tr>
                    <tr style="border-bottom:1px solid #f3f4f6;">
                      <td style="padding:8px 0;color:#9ca3af;">Amount</td>
                      <td style="padding:8px 0;text-align:right;font-weight:700;font-size:18px;color:${isApproved ? "#16a34a" : "#dc2626"};">
                ...
                <div style="border-top:1px solid #e5e7eb;padding-top:20px;text-align:center;">
                  <p style="font-size:12px;color:#16a34a;font-weight:600;margin:0 0 8px;">
                    🔒 FDIC Insured · 256-bit Encryption
                  </p>
                  <p style="color:#9ca3af;font-size:12px;margin:4px 0;">
                    support@crownledgerapp.com · +1 (800) 276-9654
                  </p>
