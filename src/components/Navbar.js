    ...
    <nav className="w-full bg-white/95 backdrop-blur-md border-b border-gray-100 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <ul className="hidden md:flex items-center gap-8 list-none">
          <li>
            <Link href="/#features" className="text-sm text-gray-500 hover:text-blue-600 font-medium transition">
              Features
            </Link>
          </li>
          <li>
            <Link href="/#accounts" className="text-sm text-gray-500 hover:text-blue-600 font-medium transition">
              Accounts
            </Link>
          </li>
          <li>
            <Link href="/#pricing" className="text-sm text-gray-500 hover:text-blue-600 font-medium transition">
              Pricing
            </Link>
          </li>
          <li>
            <Link href="/#security" className="text-sm text-gray-500 hover:text-blue-600 font-medium transition">
              Security
            </Link>
          </li>
          <li>
            <Link href="/about" className="text-sm text-gray-500 hover:text-blue-600 font-medium transition">
              About
            </Link>
          </li>
        </ul>
      ...
      {menuOpen && (
        <div className="md:hidden bg-white border-t border-gray-100 px-6 py-4 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2 pt-2 border-t border-gray-100">
            <Link
              href="/login"
              className="text-sm font-medium text-center text-gray-600 border border-gray-200 py-2 rounded-lg hover:border-blue-300"
              onClick={() => setMenuOpen(false)}
            >
              Log in
            </Link>
            <Link
              href="/signup"
              className="text-sm font-medium text-center text-white bg-blue-600 py-2 rounded-lg hover:bg-blue-700"
              onClick={() => setMenuOpen(false)}
            >
              Get Started
            </Link>
